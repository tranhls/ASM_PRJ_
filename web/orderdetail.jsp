    ...
    <body> 
        ...
        <div class="container">
            ...
            <div class="placeholder">
                <div class="parallax-window" data-parallax="scroll" data-image-src="https://posapp.vn/wp-content/uploads/2020/09/%C4%91%E1%BB%93ng-b%E1%BB%99-n%E1%BB%99i-th%E1%BA%A5t.jpg">
                    <div class="tm-header">
                        <div class="row tm-header-inner">
                            <div class="col-md-6 col-12">
                                ...
                                <div class="tm-site-text-box">
                                    ...
                                    <h6 class="tm-site-description">Delicious - Nutritious - Cheapest Hola</h6>	
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="placeholder-2">
                            <div class="parallax-window-2" data-parallax="scroll" data-image-src="https://posapp.vn/wp-content/uploads/2020/09/%C4%91%E1%BB%93ng-b%E1%BB%99-n%E1%BB%99i-th%E1%BA%A5t.jpg"></div>		
                        </div>
                    </div>
                </div>
            </div>
            <footer class="tm-footer">
                <div class="tm-address">
                    ...
                    <a href="tel:0971065539" class="tm-contact-link">
                        <i class="fas fa-phone tm-contact-icon"></i>0971065539
                    </a>
                    <a href="mailto:donhattrunganh@gmail.com" class="tm-contact-link">
                        <i class="fas fa-envelope tm-contact-icon"></i>donhattrunganh@gmail.com
                    </a>
                    <div class="tm-contact-social">
                        <a href="https://www.facebook.com/profile.php?id=100017142758851" class="tm-social-link"><i class="fab fa-facebook tm-social-icon"></i></a>
                        <a href="https://www.instagram.com/tranh.lsss/" class="tm-social-link"><i class="fab fa-instagram tm-social-icon"></i></a>
                    </div>
                </div>
            </footer>
        </div>
